...
const merchants = [
  { id: 1, name: 'إلكترونيات اليمن', banner: '/merchant-banner-default.jpg', avatar: '/testimonial-avatar-1.jpg', verified: true, golden: true, category: 'إلكترونيات', rating: 4.9, products: 1250, description: 'أفضل المنتجات الإلكترونية بأسعار تنافسية وضمان شامل' },
  { id: 2, name: 'تراث صنعاء', banner: '/merchant-banner-default.jpg', avatar: '/testimonial-avatar-3.jpg', verified: true, golden: false, category: 'أزياء تقليدية', rating: 4.8, products: 890, description: 'ملابس تراثية يمنية أصيلة مطرزة بأيدي يمنية' },
  { id: 3, name: 'عسل حضرموت', banner: '/merchant-banner-default.jpg', avatar: '/testimonial-avatar-2.jpg', verified: true, golden: true, category: 'منتجات غذائية', rating: 5.0, products: 45, description: 'عسل سدر يمني أصلي ١٠٠٪ من خيرات اليمن' },
  { id: 4, name: 'مجوهرات التراث', banner: '/merchant-banner-default.jpg', avatar: '/testimonial-avatar-3.jpg', verified: true, golden: false, category: 'مجوهرات وحرف', rating: 4.7, products: 320, description: 'مجوهرات فضة يمنية تقليدية منقوشة يدوياً' },
  { id: 5, name: 'عود اليمن', banner: '/merchant-banner-default.jpg', avatar: '/testimonial-avatar-1.jpg', verified: true, golden: true, category: 'عطور وبخور', rating: 4.9, products: 67, description: 'بخور وعود يمني فاخر طبيعي ١٠٠٪' },
  { id: 6, name: 'بيت التراث', banner: '/merchant-banner-default.jpg', avatar: '/testimonial-avatar-2.jpg', verified: true, golden: false, category: 'منزل وأثاث', rating: 4.6, products: 210, description: 'أثاث وديكور يمني تقليدي بأناقة عصرية' },
];
...
export default function FeaturedMerchants() {
  ...
  useEffect(() => {
    const ctx = gsap.context(() => {
      gsap.fromTo('.fm-header', { y: 40, opacity: 0 }, {
        y: 0, opacity: 1, duration: 0.5, ease: 'expo.out',
        scrollTrigger: { trigger: sectionRef.current, start: 'top 80%' },
      });
      gsap.fromTo('.fm-card', { y: 40, opacity: 0 }, {
          ...
          {merchants.map((merchant) => (
            ...
            >
              ...
              <div className="relative h-[120px] overflow-hidden">
                <img src={merchant.banner} alt="" className="w-full h-full object-cover" />
              ...
              <div className="relative px-5 pb-5 -mt-10">
                <div className="flex items-end gap-3 mb-3">
                  ...
                  <div className="flex items-center gap-1 mb-1">
                    {merchant.verified && <img src="/trust-badge-verified.svg" alt="موثق" className="w-5 h-5" />}
                    {merchant.golden && <img src="/trust-badge-golden.svg" alt="ذهبي" className="w-5 h-5" />}
                  </div>
                </div>

                <h3 className="font-cairo font-bold text-white text-lg mb-1">{merchant.name}</h3>
                ...
                <div className="flex items-center justify-between">
                  <div className="flex items-center gap-3 text-sm">
                    ...
                    <span className="text-[#AAAAAA] font-mono">{merchant.products} منتج</span>
                  </div>
                </div>
