# PHASE 16 + 17 — Frontend SPA Smoke + Full Regression Runner
...
> **Status:** ✅ Done — scripts at [`tests/e2e/phase16_frontend_spa.ps1`](../../../tests/e2e/phase16_frontend_spa.ps1) and [`tests/e2e/phase17_full_regression.ps1`](../../../tests/e2e/phase17_full_regression.ps1)
...
| File | Lines | What it owns |
|------|-------|--------------|
| `tests/e2e/phase17_full_regression.ps1` | 13-30 | Phase list |
| `tests/e2e/phase17_full_regression.ps1` | 33-45 | Rate-limit reset |
| `tests/e2e/phase17_full_regression.ps1` | 55-88 | Phase execution loop |
| `tests/e2e/phase17_full_regression.ps1` | 90-129 | Summary + report |
...
- [`../../../tests/e2e/phase17_full_regression.ps1`](../../../tests/e2e/phase17_full_regression.ps1) — the orchestrator
...
> **End of PHASE 16 + 17 Design Specification.** This is the LAST spec in
