 ...
 */
export function renderBilingual(input: { event: EventType; data: Record<string, string | number> }): {
  subject: string;
  body: string;
} {
  const en = renderEN(input.event, input.data);
...
// English templates
// ---------------------------------------------------------------------------
function renderEN(event: EventType, data: Record<string, string | number>): { subject: string; body: string } {
  switch (event) {
    case 'order_placed':
      return {
...
// Arabic templates
// ---------------------------------------------------------------------------
function renderAR(event: EventType, data: Record<string, string | number>): { subject: string; body: string } {
  switch (event) {
    case 'order_placed':
      return {
