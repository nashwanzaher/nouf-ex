...
const trustFeatures = [
	{
		icon: ShieldCheck,
		title: 'نوف-بروتكت',
		desc: 'نظام ضمان الدفع — أموالك محمية',
		color: '#10B981',
	},
	{ icon: Star, title: 'نوف-ريتينج', desc: 'تقييم متعدد الأبعاد — شفاف وعادل', color: '#D4A853' },
	{
		icon: MessageSquare,
		title: 'نوف-ريزولف',
		desc: 'مركز تسوية النزاعات — حلول سريعة',
		color: '#2563EB',
	},
				...
				<div className="grid grid-cols-1 lg:grid-cols-2 gap-10 lg:gap-16 items-center">
					...
					<div className="np-content">
						...
						<p className="text-[#6B6B6B] text-sm md:text-lg font-cairo leading-relaxed mb-8 max-w-lg">
							نظام حماية شامل يضمن حقوق الطرفين. أموالك محمية حتى تستلم طلبك، وتقييمات
							شفافة تكشف عن تجار موثوقين.
						</p>
						...
						<div className="np-features space-y-5 mb-8">
							{trustFeatures.map((feature) => {
								...
								return (
									<div
										key={feature.title}
										className="np-feature flex items-start gap-4"
									>
										<div
										...
										<div>
											...
											<p className="text-[#6B6B6B] text-xs md:text-sm font-cairo">
												{feature.desc}
											</p>
										</div>
									</div>
