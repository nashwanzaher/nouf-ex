      ...
      <div className="animate-in slide-in-from-left-4 duration-500">
        {!submitted ? (
          <>
            {/* Header */}
            <div className="mb-8">
              <h1 className="text-3xl font-amiri font-bold text-[#1A1612] mb-2">استعادة كلمة المرور</h1>
            ...
            <form onSubmit={handleSubmit} className="space-y-5">
              <div>
                <Label className="font-cairo text-sm text-[#111111]">البريد الإلكتروني</Label>
                <div className="relative mt-1.5">
                  <Mail className="absolute right-3 top-1/2 -translate-y-1/2 w-5 h-5 text-[#AAAAAA]" strokeWidth={1.5} />
                  <Input
                    type="email"
                    value={email}
                ...
                {error && <p className="text-[#EF4444] text-xs font-cairo mt-1">{error}</p>}
              </div>
          ...
          <div className="text-center animate-in zoom-in-95 duration-300">
            ...
            <h2 className="text-2xl font-amiri font-bold text-[#1A1612] mb-3">تم الإرسال!</h2>
            <p className="text-[#6B6B6B] font-cairo text-sm leading-relaxed mb-2">
              تحقق من بريدك الإلكتروني
            </p>
            <p className="text-xs text-[#AAAAAA] font-cairo mb-8">
              لقد أرسلنا رابط استعادة كلمة المرور إلى <span className="font-semibold text-[#6B6B6B]">{email}</span>
            </p>
