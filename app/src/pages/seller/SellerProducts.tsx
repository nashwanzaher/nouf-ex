...
const mockProducts: Product[] = [
	...
	{
		id: 9,
		name: 'مجوهرات فضة يمنية تقليدية',
		price: '٣٥,٠٠٠',
		stock: 0,
		status: 'disabled',
		views: 420,
...
function StatusBadge({ status }: { status: Product['status'] }) {
	...
	return (
		<span className={cn('px-2 py-1 rounded-lg text-[11px] font-bold font-cairo', c.className)}>
			{c.label}
		</span>
	);
}
