...
Invoke-Expression $cmd 2>&1 | Out-File -Encoding utf8 "$PSScriptRoot\scripts\_docker_run.out"
$LASTEXITCODE | Out-File -Encoding ascii "$PSScriptRoot\scripts\_docker_run_exit.txt"
