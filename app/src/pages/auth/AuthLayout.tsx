...
export default function AuthLayout({ children, showBackLink = true, backLink = '/', backLabel = 'العودة للرئيسية' }: AuthLayoutProps) {
  return (
      ...
      <div className="hidden md:flex md:w-[40%] lg:w-[45%] relative flex-col items-center justify-center p-10 gradient-hero overflow-hidden">
        ...
        <div className="relative z-10 text-center">
          ...
          <div className="flex items-center justify-center gap-4 mb-8">
            ...
            <div className="flex flex-col items-center gap-1">
              <div className="w-10 h-10 bg-[#1A1612]/10 rounded-xl flex items-center justify-center">
                <svg className="w-5 h-5 text-[#1A1612]" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth={1.5}>
