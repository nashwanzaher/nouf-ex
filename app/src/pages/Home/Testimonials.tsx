					...
					<div ref={emblaRef} className="overflow-hidden">
						<div className="flex gap-5">
							{testimonials.map((t, i) => (
								<div
									key={i}
									className="tm-card flex-shrink-0 w-[320px] md:w-[380px]"
								>
									<div className="bg-[#F8F8F8] rounded-3xl p-6 md:p-8 h-full">
										...
										<div className="flex items-center justify-between">
											<div className="flex items-center gap-3">
												...
												/>
												<div>
													<h4 className="font-cairo font-bold text-sm text-[#111111]">
														{t.name}
													</h4>
											...
											<div className="flex items-center gap-1 text-[#10B981]">
												<CheckCircle
													...
													strokeWidth={2}
												/>
												<span className="text-[10px] font-cairo font-semibold">
													تجربة موثقة
												</span>
											</div>
										</div>
