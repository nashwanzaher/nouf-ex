...
const navItems: NavItem[] = [
	...
	{ to: '/admin/reviews', labelKey: 'admin.navReviews', icon: Star },
	{ to: '/admin/coupons', labelKey: 'admin.navCoupons', icon: Ticket },
	{ to: '/admin/notifications', labelKey: 'admin.navNotifications', icon: Megaphone },
	...
	{ to: '/admin/system', labelKey: 'admin.navSystemHealth', icon: Activity },
];
